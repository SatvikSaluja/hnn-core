...
for cell_type in net.gid_ranges:
    gid = list(net.gid_ranges[cell_type])[0]  #we only take one cell , as all cells have a copy of synapse_tree so 
    #all cell will have same location
